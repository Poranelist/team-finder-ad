...
urlpatterns = [
    ...
    path("<int:project_id>/complete/", CompleteProjectView.as_view(), name="complete_project"),
    path("<int:project_id>/toggle-favorite/", ToggleFavoriteView.as_view(), name="toggle_favorite"),
    path("<int:project_id>/toggle-participate/", ToggleParticipateView.as_view(), name="toggle_participate"),
]
